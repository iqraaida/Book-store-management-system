...
public void display(){
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Book Year");
        jPanel2.add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 400, -1, -1));

        jLabel6.setText("Book Version");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 330, -1, -1));

        jLabel7.setText("Book Price");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 460, -1, -1));

        jLabel8.setText("Author ID");
        jPanel2.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 530, -1, -1));

        jLabel9.setText("Publisher ID");
        jPanel2.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 590, -1, -1));
        ...
        txt4.setToolTipText("");
        txt4.setPlaceholder("Enter Book Version");
        jPanel2.add(txt4, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 330, -1, -1));

        txt3.setForeground(new java.awt.Color(153, 153, 153));
        txt3.setToolTipText("");
        txt3.setPlaceholder("Enter Book Year");
        jPanel2.add(txt3, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 390, -1, -1));

        txt5.setForeground(new java.awt.Color(153, 153, 153));
        txt5.setToolTipText("");
        txt5.setPlaceholder("Enter Book Price");
        jPanel2.add(txt5, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 440, -1, -1));
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 0, 640, 770));
    ...
    private void rSButtonMaterialIconOne3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne3ActionPerformed
        // TODO add your handling code here:
           String sql= "update book set title='"+txt2.getText()+"',version='"+txt3.getText()+"',year='"+txt4.getText()+"',price='"+txt5.getText()+"' ,authorid='"+txt6.getText()+"' ,publisherid='"+txt7.getText()+"'  where id='"+txt1.getText()+"'   ";
        co.setSQL(sql);
        display();
        txt1.setText("");
        txt2.setText("");
    ...
    private void rSButtonMaterialIconOne2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne2ActionPerformed
        // TODO add your handling code here:
         String sql= "insert into book values('"+txt1.getText()+"','"+txt2.getText()+"','"+txt4.getText()+"','"+txt3.getText()+"','"+txt5.getText()+"','"+txt6.getText()+"','"+txt7.getText()+"')";
        co.setSQL(sql);
        display();
        txt1.setText("");
        txt2.setText("");
    ...
    private void rSButtonMaterialIconOne5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne5ActionPerformed
        // TODO add your handling code here:
           String sql="select * from book where id='"+txt1.getText()+"' or title='"+txt2.getText()+"' or version='"+txt3.getText()+"'or year='"+txt4.getText()+"'or price='"+txt5.getText()+"'or authorid='"+txt6.getText()+"'or publisherid='"+txt7.getText()+"'  ";
        co.search(sql);
        try{
            if(co.rs.next()){
                id=co.rs.getString("id");
                txt1.setText(co.rs.getString("id"));
                txt2.setText(co.rs.getString("title"));
                txt3.setText(co.rs.getString("version"));
                 txt4.setText(co.rs.getString("year"));
                txt5.setText(co.rs.getString("price"));
                txt6.setText(co.rs.getString("authorid"));
                txt7.setText(co.rs.getString("publisherid"));
            }
            else
    ...
    private void rSButtonMaterialIconOne1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne1ActionPerformed
        // TODO add your handling code here:
        String sql="delete from book where id='"+txt1.getText()+"' ";
          co.setSQL(sql);
        display();
         txt1.setText("");
        txt2.setText("");
