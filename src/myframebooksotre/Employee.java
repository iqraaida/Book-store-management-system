...
public void display(){
    ...
    private void initComponents() {
        ...
        jPanel2.add(txt3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 270, -1, -1));
        ...
        jPanel2.add(txt4, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 330, -1, -1));
        ...
        jPanel2.add(txt5, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 400, -1, -1));
        ...
        jPanel2.add(rSButtonMaterialIconOne2, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 550, 110, -1));
        ...
        jPanel2.add(rSButtonMaterialIconOne3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 550, 110, -1));
        ...
        jPanel2.add(rSButtonMaterialIconOne1, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 550, 110, -1));
        ...
        jPanel2.add(rSButtonMaterialIconOne5, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 630, 110, -1));
        ...
        jPanel1.add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(622, 1, 570, 800));
    ...
    private void rSButtonMaterialIconOne3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne3ActionPerformed
        // TODO add your handling code here:
           String sql= "update employee set name='"+txt2.getText()+"',address='"+txt3.getText()+"',phone='"+txt4.getText()+"',email='"+txt5.getText()+"' where id='"+txt1.getText()+"'   ";
        co.setSQL(sql);
        display();
        txt1.setText("");
        txt2.setText("");
    ...
    private void rSButtonMaterialIconOne5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne5ActionPerformed
        // TODO add your handling code here:
           String sql="select * from employee where id='"+txt1.getText()+"' or name='"+txt2.getText()+"' or address='"+txt3.getText()+"'or phone='"+txt4.getText()+"'or email='"+txt5.getText()+"' ";
        co.search(sql);
        try{
            if(co.rs.next()){
    ...
    private void rSButtonMaterialIconOne1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rSButtonMaterialIconOne1ActionPerformed
        // TODO add your handling code here:
        String sql="delete from employee where id='"+txt1.getText()+"' ";
          co.setSQL(sql);
        display();
         txt1.setText("");
        txt2.setText("");
